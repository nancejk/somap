...
bool somapfunctor_cartesian_distance(int argc, char *argv[]) {
  ...
  std::auto_ptr<somapnode>
    n0(new (std::nothrow) somapnode(POS, NODESIZE));
  // Nodes for weight comparison
  std::auto_ptr<somapnode>
    n1(new (std::nothrow) somapnode(POS, NODESIZE));
  std::auto_ptr<somapnode>
    n2(new (std::nothrow) somapnode(POS, NODESIZE));
  std::auto_ptr<somapnode>
    n3(new (std::nothrow) somapnode(POS, NODESIZE));
